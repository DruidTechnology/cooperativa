                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Pago de Credito</a></li>
                            </ul>
                                ...
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <label>Apellidos Afiliado</label>
                                                                    <input  type="text" class="form-control" placeholder="Escriba apellido">
                                                                </div>
                                                                <div class="form-group">
                                                                <label>Numero de DUI</label>
                                                                <div class="input-mark-inner mg-b-22">
                                                                <input type="text" class="form-control" data-mask="9999999-9" placeholder="">
                                                                ...
                                                                <div class="input-mark-inner mg-b-22">
                                                                <input type="text" class="form-control" data-mask="999-999999-999-9" placeholder="">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                            <div class="input-mark-inner mg-b-22">
                                                <input type="text" class="form-control" data-mask="$ 9,999.99" placeholder="">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                            <div class="input-mark-inner mg-b-22">
                                                <input type="text" class="form-control" data-mask="9 %" placeholder="">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                            <div class="input-mask-title">
                                                <label>Monto En Deuda</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                            <div class="input-mark-inner mg-b-22">
                                                <input type="text" class="form-control" data-mask="$ 99" placeholder="">
