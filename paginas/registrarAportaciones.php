            ...
            <div class="sparkline10-graph">
                <div class="input-knob-dial-wrap">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="chosen-select-single mg-b-20">
                                <label>Seleccione el Concepto de Aportacion</label>
                                <select data-placeholder="Choose a Country..." class="chosen-select" tabindex="-1">
                                    <option value="">Seleccionar</option>
                                    <option value="United Arab Emirates">Ahorro</option>
                                    <option value="United Kingdom">Aportacion Ordinaria</option>
                                    <option value="United States">Aportacion Extraordinaria</option>
                                </select>
                            </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="product-payment-inner-st">
            <ul id="myTabedu1" class="tab-review-design">
                <li class="active"><a href="#description">Anexar Aportacion</a></li>
            </ul>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-mark-inner mg-b-22">
                                                        <input type="text" class="form-control" data-mask="9999999-9"
                                                            placeholder="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-mark-inner mg-b-22">
                                                        <input type="text" class="form-control"
                                                            data-mask="999-999999-999-9" placeholder="">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                            <div class="input-mark-inner mg-b-22">
                                                                <input type="text" class="form-control"
                                                                    data-mask="$ 9,999.99" placeholder="">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                            <div class="input-mask-title">
                                                                <label>Tasa de Interes Aprobada</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                            <div class="input-mark-inner mg-b-22">
                                                                <input type="text" class="form-control" data-mask="9 %"
                                                                    placeholder="">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                            <div class="input-mark-inner mg-b-22">
                                                                <input type="text" class="form-control"
                                                                    data-mask="99 Meses" placeholder="">
