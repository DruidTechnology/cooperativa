<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Username = 'monterrosadelgado@gmail.com'; //Modificar
		$mail->Password = 'Monterrosa0721'; //Modificar
		
		$mail->setFrom('monterrosadelgado@gmail.com', 'Codigo de Programacion'); //Modificar
